...
import 'package:trips_app2/Place/ui/widgets/title_input_location.dart';
import 'package:trips_app2/User/bloc/bloc_user.dart';
import 'package:trips_app2/User/ui/widgets/gradient_profile.dart';
import 'package:trips_app2/widgets/button_purple.dart';
import 'package:trips_app2/widgets/text_input.dart';
import 'package:trips_app2/widgets/title_header.dart';
...
class _AddPlaceScreenState extends State<AddPlaceScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          GradientProfile(height: 375.0, title: "",),
          Row(
            children: [
              Container(
                ...
                child: SizedBox(
                  ...
                  child: IconButton( onPressed: () {
                    Navigator.pop(context); }, icon: const Icon(Icons.keyboard_arrow_left, color: Colors.white, size: 45.0,)),
                ),
              ),
              Flexible(
                child: Container(
            ...
            child: ListView(
              children: [
                Container(
                  ...
                  child:CardImage(pathImage: widget.image.path, widthC: 350, heightC: 250, withoutMargin: false, first: true, iconData: Icons.camera_alt, onPressedFabIcon: () {},),
                ), //Foto
                Container(
                ...
                Container(
                   ...
                   child: TextInputLocation(hintText: "Add Location", iconData: Icons.location_on_outlined, controller:_controllerLocation,)
                ),
                Container(
                  width: 70.0,
                  child: ButtonPurple(
